...
@Component({
  selector: 'app-borron-y-cuenta-nueva',
  templateUrl: './borron-y-cuenta-nueva.page.html',
  styleUrls: ['./borron-y-cuenta-nueva.page.scss'],
})
export class BorronYCuentaNuevaPage implements OnInit {
