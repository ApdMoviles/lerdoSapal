...
@Component({
  selector: 'app-cancelacion-de-servicio',
  templateUrl: './cancelacion-de-servicio.page.html',
  styleUrls: ['./cancelacion-de-servicio.page.scss'],
})
export class CancelacionDeServicioPage implements OnInit {
