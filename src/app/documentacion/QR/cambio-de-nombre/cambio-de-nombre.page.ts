...
@Component({
  selector: 'app-cambio-de-nombre',
  templateUrl: './cambio-de-nombre.page.html',
  styleUrls: ['./cambio-de-nombre.page.scss'],
})
export class CambioDeNombrePage implements OnInit {
  response: any;
