...
@Component({
  selector: 'app-carta-no-servicio',
  templateUrl: './carta-no-servicio.page.html',
  styleUrls: ['./carta-no-servicio.page.scss'],
})
export class CartaNoServicioPage implements OnInit {
  response: any;
